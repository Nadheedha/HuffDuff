package com.example.mp.wayfinding;
...
import com.example.mp.ListExamplesActivity;
...
public class WayfindingOverlayActivity extends FragmentActivity
    ...
    private IARegion.Listener mRegionListener = new IARegion.Listener() {
        ...
        public void onEnterRegion(final IARegion region) {
            if (region.getType() == IARegion.TYPE_FLOOR_PLAN) {
                ...
                setupPoIs(mVenue.getPOIs(), 2);//region.getFloorPlan().getFloorLevel());
    ...
    private void setupGroundOverlay(IAFloorPlan floorPlan, Bitmap bitmap) {
        ...
        if (mMap != null) {
            ...
            LatLng center = new LatLng(13.059291505740028, 80.23365391658784);//iaLatLng.longitude);
            GroundOverlayOptions fpOverlay = new GroundOverlayOptions()
                    .image(bitmapDescriptor)
                    .zIndex(0.0f)
                    .position(center, floorPlan.getWidthMeters()+12, floorPlan.getHeightMeters()+31)
