package com.example.mp.geofence;
...
public class GeofenceMapsOverlayActivity extends FragmentActivity implements LocationListener, OnMapReadyCallback, IAGeofenceListener {
    ...
    private void fetchFloorPlanBitmap(final IAFloorPlan floorPlan) {
        ...
        RequestCreator request = Picasso.get().load("https://ida-fp-images-prod.s3.eu-west-1.amazonaws.com/82082bd5-4a8d-4563-9b1f-4d8acbd59296/0936dddf-be17-4bf3-8ecd-f843a6eb6361");
